# Pre-condition Gate — `state-read.sh` fail-fast Pattern SoT (PR #1079 reduced scope)

> **PR #1079 変更点**: 旧 sub-skill chain (start-execute / start-publish / start-finalize) と
