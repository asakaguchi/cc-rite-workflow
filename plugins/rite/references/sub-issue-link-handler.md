...
- 旧 caller (retired): `parent-routing.md` child creation path (Variant A) / `create-decompose.md` Phase 3.3 (Variant B) / `commands/issue/create.md` ステップ 5.4 inline (Variant B、`scripts/decompose-issues.sh` へ抽出)
