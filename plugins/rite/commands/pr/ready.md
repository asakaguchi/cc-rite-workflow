...
# before sub-skill invocation, and by the sub-skills `pr/review.md` ステップ 8.0 /
# `pr/fix.md` ステップ 5.1) must be accepted — the legacy names are retained in the
