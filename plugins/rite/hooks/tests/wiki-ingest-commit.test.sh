...
# expensive to set up in CI. These static pins protect the same_branch strategy
# from silent regressions of the stderr capture symmetry that the separate_branch
# strategy already enforces via dump_git_err.
