...
| ケース | path 例 |
|--------|---------|
| 同ドメイン内 | `./other-page.md` または `other-page.md` |
...
確信ある関連ページが特定できない場合、Phase 5.3 F-14 fix に従い `## 関連ページ` セクション全体を Edit ツールで以下に置き換えてください（空 placeholder のままにすると Markdown リンク `[]()` が破綻するため）:
