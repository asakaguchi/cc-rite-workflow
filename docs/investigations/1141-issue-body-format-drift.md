...
| 4 | Implementation Details (4.1-4.5) | S | M | M | M | M | `template-structure.md:120-184` |
...
なお、行 4 (Implementation Details) は 4.1〜4.5 の sub-section をひとつの行に集約しているため、XS 列の必須度が他 sub-section と一致しない。詳細は `default.md:38-42` を参照:

- 4.1 Target Files / 4.4 Behavioral Requirements: 全 Complexity で M
