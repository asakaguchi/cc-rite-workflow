...
加えて以下も PR-7 で対応する:
- IMP-2: `parent-routing-pattern-interim.test.sh` TC-7a を `count >= 2` に強化し create.md L66 (Halt rule) + L251 (Phase 1 return branch) を独立 pin
