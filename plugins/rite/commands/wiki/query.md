...
> - `plugins/rite/commands/issue/start.md` ステップ 3 (実装計画、PR #1079 で旧 `implementation-plan.md` Phase 3.0.W を統合)
...
|---------|--------------|------------------|--------------|
| `/rite:issue:start` | 実装計画生成前 | Issue タイトル + ラベル + 変更対象ファイル名 | `start.md` ステップ 3 (PR #1079 で旧 `implementation-plan.md` Phase 3.0.W を統合) |
