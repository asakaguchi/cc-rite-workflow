...
>
> **抽出経緯**: `start.md` の Sentinel Visibility Rule (旧 line 1329-1357) と各 callsite (Phase 5.2 lint:aborted / 5.3 pr:create-failed / 5.4.4 fix:error / 5.5 ready:error) に散在していた orchestrator-direct emit bash を 1 ファイルへ集約。`workflow-incident-detection.md` (ステップ 8.5 SoT) と pair で使用する。
