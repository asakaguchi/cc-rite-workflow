...
このドキュメントは `plugins/rite/commands/skills/wiki-lint/SKILL.md` の **ステップ 7 (壊れた相互参照検出)** で使用する
...
- `plugins/rite/commands/skills/wiki-lint/SKILL.md` ステップ 7 (壊れた相互参照検出、helper 委譲)
