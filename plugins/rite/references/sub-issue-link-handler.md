...
- [`commands/issue/create.md`](../commands/issue/create.md) ステップ 5.4 (Sub-Issues API Linkage in Decompose Path) — Variant B の利用箇所 (PR #1079 で旧 `create-decompose.md` Phase 3.3 を統合)
- 旧 caller (PR #1079 で削除): `parent-routing.md` child creation path (Variant A) / `create-decompose.md` Phase 3.3 (Variant B)
