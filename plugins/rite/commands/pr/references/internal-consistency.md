...
>
> **Canonical category names** (literal-substring matched by `commands/pr/review.md` Phase 5.1.3 META check — 表記揺れは `doc_heavy_post_condition: warning` false positive の原因):
>
...
- [`../review.md`](../review.md) — Phase 1.2.7 Detection / Phase 2.2.1 Override / Phase 5.1.3 Post-Condition Check
