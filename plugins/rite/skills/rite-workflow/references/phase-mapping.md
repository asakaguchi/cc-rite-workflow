...
| `ingest` | Wiki ingest 実行中 (legacy transient phase — 現行 cleanup.md ステップ 9 / review.md Phase 6.5.W / fix.md Phase 4.6.W は phase=ingest を書き込まない) | `/rite:pr:cleanup` ステップ 9 (legacy state file の resume routing 用途のみ) |
