...
#   RE-ENTRY 累積カウントが unreachable になる (resume.md / phase-transition-whitelist の
#   エスカレーション判定が常に 0 開始になり、再 entry を検知できなくなる)。
