...
- `plugins/rite/commands/wiki/lint.md` ステップ 6.0 — `log_read_ok` 4 値 enum (unknown / true / absent / io_error)。
...
- `plugins/rite/commands/pr/review.md` ステップ 6.1.a — `JSON_SAVED=true|false`、`FILE_TIMESTAMP=<ts>` の
...
- `plugins/rite/commands/wiki/lint.md` ステップ 6.0 — `---skipped_refs_begin---` / `---skipped_refs_end---` で
